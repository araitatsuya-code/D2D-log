...
# 制作背景
自分の勉強時間や努力を蓄積、視覚化することはモチベーションアップに繋がる良い習慣ですが
多くの方は途中でやめてしまっている現状があり、私はその理由の一つとして
・前日の自分の投稿からコピペ、貼り付け、編集〜という手間
に原因があるのではないかと思いました。
その様な問題を解決し、学習に役立てられれば良いと思いこのアプリを作りました。
...
インフラ
AWS（EC2）へのデプロイ、Route５３を使用したドメイン設定
